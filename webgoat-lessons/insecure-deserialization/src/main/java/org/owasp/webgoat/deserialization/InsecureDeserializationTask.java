...
import io.whitesource.cure.SecureObjectInputStream;
...
public class InsecureDeserializationTask extends AssignmentEndpoint {
    ...
    public AttackResult completed(@RequestParam String token) throws IOException {
        ...
        //TODO: fill white list with relevant classes
        Set<String> authorizedClasses = Sets.newHashSet();
        try (SecureObjectInputStream ois = new SecureObjectInputStream(new ByteArrayInputStream(Base64.getDecoder().decode(b64token)), authorizedClasses)) {
